...
function createMessageElement(message) {
    if (message.role === 'user') {
        ...
        // PERUBAHAN JS: Padding logo chat diubah dari p-1 (4px) menjadi p-1.5 (6px) agar sesuai dengan CSS
        avatar.innerHTML = `<img src="${LOGO_URL_SMALL}" alt="Logo" class="w-full h-full object-cover rounded-full p-1.5" onerror="this.src='${LOGO_URL_SMALL}';"/>`;
